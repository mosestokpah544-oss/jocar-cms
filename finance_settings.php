...
.main h3, .main h2, .table-box h4 {
    margin-bottom: 20px;
    color: #333;
}

.table-box h4 i { margin-right: 8px; }
...
.btn{padding:10px 15px;border:none;cursor:pointer;border-radius:5px;font-weight:bold;margin-top:10px;}
...
<div class="container">
    ...
    <div class="main">
        ...
        <!-- Update Info -->
        <div class="table-box">
            <h4><i class="fas fa-user"></i> Update Full Name & Email</h4>
            <form method="POST">
                ...
                <button type="submit" name="update_info" class="btn btn-submit"><i class="fas fa-edit"></i> Update Info</button>
            </form>
        </div>
